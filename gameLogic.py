import pygame #Used for creating the game window and handling graphics.
import random #For generating random numbers, crucial for the genetic algorithm.
import os
import math
import numpy as np
import time
...
#Shapely: For geometric operations, used in collision detection or track design.
...
def move(point, angle, unit): #Translate a point in a given direction
  """
    Translates a point in a given direction by a specified distance (unit).
    
    Parameters:
    - point: The (x, y) coordinates of the original point.
    - angle: The direction in which to move, specified in degrees.
    - unit: The distance to move the point.
